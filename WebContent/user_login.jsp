...
<head>
<meta charset="UTF-8">
<title>User Login | Bus Crowd Analyzer</title>
...
<div class="row align-items-center justify-content-center">
    ...
    <div class="col-lg-6 mb-4 hero-text">
        ...
        <p>
            Login to check real-time bus crowd status,
            routes, timings and travel smart.
        </p>
    </div>
    ...
    <div class="col-lg-5">
        <div class="login-wrap">
            ...
            <p class="text-center mt-3">
                New user?
                <a href="user_registration.jsp" style="color:#7a3cff;font-weight:600;">
                    Register here
                </a>
            </p>
