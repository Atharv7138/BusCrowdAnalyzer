...
<head>
<meta charset="UTF-8">
<title>View Extra Buses | Bus Depot Panel</title>
...
function confirm_alert() {
    return confirm("Are you sure you want to delete this extra bus?");
}
</script>
</head>
...
<div class="header-bar">
    <h4>Extra Bus Directory</h4>
    <span>All extra buses requested by this depot</span>
</div>
<!-- ################################################## BUTTON FOR ADD EXTRA BUS ############################################### -->
<div class="table-action-bar">
<a href="AddExtraBus.jsp">
...
try{
    ...
    ps = con.prepareStatement(
        "SELECT * FROM extra_buses WHERE demail=? ORDER BY id DESC"
    );
...
%>
        <tr>
            ...
            <td class="text-center">
                <a href="DeleteExtraBus.jsp?id=<%= rs.getInt("id") %>"
