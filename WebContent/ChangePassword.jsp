    ...
    if (!newPassword.equals(confirmPassword)) {
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement(
                "SELECT Password FROM busdepot WHERE id=?"
            );
            ps.setInt(1, id);
            ...
            if (rs.next()) {
                ...
                if (!dbPassword.equals(currentPassword)) {
                    ...
                    PreparedStatement ps2 = con.prepareStatement(
                        "UPDATE busdepot SET Password=? WHERE id=?"
                    );
...
<head>
<meta charset="UTF-8">
<title>Change Password | Bus Depot Panel</title>
...
<body>
<div class="back-btn">
    <a href="BusDepotDashboard.html">← Back</a>
</div>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-5">
            <div class="info-card">
                ...
                <div class="info-step"><div class="step-no">4</div><p>Keep it confidential.</p></div>
            </div>
        </div>
