...
<head>
<meta charset="utf-8">
<title>Add Extra Bus | Bus Depot Panel</title>
...
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="info-panel">
            <h4>Extra Bus Registration</h4>
            <p>
                Register extra buses for peak hours, festivals,
                or emergency crowd handling.
            </p>

            <span class="badge-step">Step 1 : Bus Identity</span><br>
            <span class="badge-step">Step 2 : Capacity</span><br>
            <span class="badge-step">Step 3 : Route & Security</span>
        </div>
    </div>
    ...
    <div class="col-lg-8">
        <div class="form-panel">
            ...
            <form action="<%= request.getContextPath() %>/AddingExtraBus" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="route" class="form-control"
                           placeholder="Eg: Pune – Mumbai" required>
                </div>
                ...
                <button class="btn btn-submit btn-block mt-3">
                    <i class="fas fa-bus mr-2"></i>Register Extra Bus
                </button>
